...
void BoxApp::Draw(const GameTimer& gt)
{
    ...
    D3D12_RESOURCE_BARRIER temp1 = CD3DX12_RESOURCE_BARRIER::Transition(CurrentBackBuffer(),
    ...
    // Indicate a state transition on the resource usage.
    D3D12_RESOURCE_BARRIER temp2 = CD3DX12_RESOURCE_BARRIER::Transition(CurrentBackBuffer(),
        D3D12_RESOURCE_STATE_RENDER_TARGET, D3D12_RESOURCE_STATE_PRESENT);
    mCommandList->ResourceBarrier(1, &temp2);
